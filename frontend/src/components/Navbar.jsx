...
function Navbar() {
    ...
    return (
    <div className='flex justify-between text-sm py-4 mb-5 border-b border-b-gray-400 items-center '>
      ...
      <div className='flex items-center gap-4'>
        {
            ...
            </div> : <button onClick={() => navigate('/login')} className='bg-[#5f6fff] cursor-pointer text-white px-8 py-3 rounded-full hidden md:block font-light'>Create Account</button>
        }
